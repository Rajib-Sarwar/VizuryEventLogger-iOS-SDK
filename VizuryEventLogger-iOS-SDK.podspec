...
Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_frameworks = 'VizuryEventLogger/Frameworks/VizuryEventLogger.framework'
  spec.preserve_paths =  'VizuryEventLogger/Frameworks/VizuryEventLogger.framework'
  spec.module_map = 'VizuryEventLogger/Frameworks/VizuryEventLogger.framework/Modules/module.modulemap'

  spec.requires_arc = true
  spec.frameworks = 'Foundation', 'UIKit', 'SystemConfiguration' , 'Security'
  spec.weak_framework = 'UserNotifications', 'Firebase'
end
